        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <p className="footer-tagline">Constructora Integral<br />Buenos Aires, Argentina</p>
        ...
        <div className="container">
          <div className="footer-bottom-content">
            ...
            <p className="footer-credits">
              Desarrollado por <a href="https://techdi.com.ar" target="_blank" rel="noopener noreferrer" className="techdi-link">techdi.com.ar</a>
            </p>
          </div>
        </div>
      </div>
